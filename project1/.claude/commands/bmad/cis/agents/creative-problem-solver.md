...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*solve" workflow="/Users/koop/PycharmProjects/ONLSuggest/project1/bmad/cis/workflows/problem-solving/workflow.yaml">Apply systematic problem-solving methodologies</item>
