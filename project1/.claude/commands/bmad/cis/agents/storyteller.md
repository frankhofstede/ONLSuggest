...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*story" exec="/Users/koop/PycharmProjects/ONLSuggest/project1/bmad/cis/workflows/storytelling/workflow.yaml">Craft compelling narrative using proven frameworks</item>
