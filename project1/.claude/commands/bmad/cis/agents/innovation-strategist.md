...
<activation critical="MANDATORY">
  ...
  <step n="2">🚨 IMMEDIATE ACTION REQUIRED - BEFORE ANY OUTPUT:
      - Use Read tool to load /Users/koop/PycharmProjects/ONLSuggest/project1/bmad/cis/config.yaml NOW
  ...
  <menu>
    ...
    <item cmd="*innovate" workflow="/Users/koop/PycharmProjects/ONLSuggest/project1/bmad/cis/workflows/innovation-strategy/workflow.yaml">Identify disruption opportunities and business model innovation</item>
