...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*assess-project-ready" validate-workflow="/Users/koop/PycharmProjects/ONLSuggest/project1/bmad/bmm/workflows/3-solutioning/workflow.yaml">Validate if we are ready to kick off development</item>
